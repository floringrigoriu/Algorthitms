 ...
 * 
 * Input: satisfaction = [-1,-4,-5] Output: 0 Explanation: People don't like the
 * dishes. No dish is prepared. Example 4:
 * 
...
public class p1402 {
    class Solution {
        public int maxSatisfaction(int[] satisfaction) {
            ...
            while (idx>=0 && (satisfaction[idx] + pos >= 0)) {
                pos+=satisfaction[idx];
                result+=pos;
                idx--;
            }
            return result;
