 ...
 * Constraints:
 * 
 * There will be at most 20000 operations. 1 <= id, t <= 10^6 All strings
 * consist of uppercase, lowercase English letters and digits. 1 <=
...
public class p1396 {
    class UndergroundSystem {
        ...
        private class Record{
            ...
            public Record(String in, String out) {
                this.checkIn = in;
                this.checkOut = out;
            }
            ...
            public boolean equals(Object o) { 
                ...
                Record r = (Record) o;
                return this.checkIn.equals(r.checkIn) && this.checkOut.equals(r.checkOut);
            }
       }
        ...
        public class Start {
            ...
            public Start(String startPoint, int time){
                name = startPoint;
                this.time = time;
            }
        }

        private Map<Record,RecordStats> storage;
        private Map<Integer, Start> starts;
        ...
        public void checkIn(int id, String stationName, int t) {
            starts.put(id, new Start(stationName,t));
        }
        
        public void checkOut(int id, String stationName, int t) {
            Start s = starts.remove(id);
            Record r = new Record(s.name, stationName);
            RecordStats rs = storage.get(r);
            if (rs == null ) {
                rs = new RecordStats();
                storage.put(r,rs);
            }
        ...
        public double getAverageTime(String startStation, String endStation) {
            return storage.get(new Record(startStation, endStation)).getAvg();
        }
    }
}